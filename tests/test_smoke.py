...
from invoice_pad.cli import main
from invoice_pad.models import Note, ProjectState, Task
from invoice_pad.cli import demo_state
from invoice_pad.storage import load_state, save_state
from invoice_pad.models import generate_short_id
from invoice_pad.validation import normalize_tags, require_text, validate_task_status
from invoice_pad.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
